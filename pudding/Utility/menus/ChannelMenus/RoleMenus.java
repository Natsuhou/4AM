...
import pudding.Utility.enums.PuddingEmotes;
...
public class RoleMenus {
    ...
    public void sendGenderMenu(TextChannel textChannel) {
        embedBuilder
                .setTitle(PuddingEmotes.GENDER.getEmoteId() + " Gender Menu")
    ...
    public void sendLocationMenu(TextChannel textChannel) {
        embedBuilder
                .setTitle("Location")
    ...
    public void sendAgeMenu(TextChannel textChannel) {
        embedBuilder
                .setTitle("\uD83D\uDD70 Age")
    ...
    public void sendDMStatusMenu(TextChannel textChannel) {
        embedBuilder
